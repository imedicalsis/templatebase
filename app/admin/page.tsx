  ...
  useEffect(() => {
    ...
    if (!isLoaded) {
      timerId = setTimeout(() => {
        ...
        if (!isLoaded) {
          console.warn("AdminPage: Timeout de carregamento do Clerk atingido!"); // Mantido um warn para o caso de timeout
    ...
    <div className="container relative z-10 mx-auto px-4 py-8">
      <div className="rounded-lg bg-white p-8 shadow-lg">
        ...
        <div className="space-y-4">
          <p className="text-gray-700 opacity-100">
            Bem-vindo ao painel administrativo do sistema EAD.
          </p>
